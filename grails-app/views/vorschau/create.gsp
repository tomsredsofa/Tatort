                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: vorschauInstance, field: 'tatort', 'errors')}">
                                    <g:select name="tatort.id" from="${net.codeplumber.tatort.Tatort.list()}" optionKey="id" value="${vorschauInstance?.tatort?.id}"  />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: vorschauInstance, field: 'sendingDate', 'errors')}">
                                    <g:datePicker name="sendingDate" precision="day" value="${vorschauInstance?.sendingDate}" years="${TatortUtils.createVorschauRange()}" />
                                </td>
                            </tr>

        ...
        <table>
            ...
            <tr>
                ...
                <g:sortableColumn property="country"
                                  title="${message(code: 'city.country.label', default: 'Country')}"/>

                <g:sortableColumn property="shortName"
                                  title="${message(code: 'city.shortName.label', default: 'Short Name')}"/>
            ...
            <g:each in="${cityInstanceList}" status="i" var="cityInstance">
                <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                    ...
                    <td><g:link action="show"
                                id="${cityInstance.id}">${fieldValue(bean: cityInstance, field: "id")}</g:link></td>

                    <td>${fieldValue(bean: cityInstance, field: "name")}</td>

                    <td>${fieldValue(bean: cityInstance, field: "country")}</td>

                    <td>${fieldValue(bean: cityInstance, field: "shortName")}</td>
